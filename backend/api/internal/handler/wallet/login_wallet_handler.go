...
func LoginWalletHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LoginWalletReq
		// 使用decode解析
		...
		l := wallet.NewLoginWalletLogic(r.Context(), svcCtx)
		resp, err := l.LoginWallet(&req)
		if err != nil {
